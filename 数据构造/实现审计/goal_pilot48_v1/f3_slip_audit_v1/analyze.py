...
D=Path('/nfs_share/lijunhui/Robotwin2/datasets/p48_f3_micro_001')
...
def main():
    ...
    write_new(Path(__file__).parent/'analysis.json',out)
    print({k:v for k,v in out.items() if k!='rows'})
    for i in (1413,1420,1430,1440,1450,1460,1473,1490,1524,1574):
