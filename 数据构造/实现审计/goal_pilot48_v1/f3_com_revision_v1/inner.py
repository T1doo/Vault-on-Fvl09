...
def run(proposals, output_path):
    ...
    value={'schema_version':'cmf_f3_topdown_inner_surface_same_section_v1','results':results,'IK_queries':0,'scenes':0,'physical_attempts':0};write_new(output_path,value);print(json.dumps([{k:r[k] for k in ('proposal_id','necessary_inner_surface_gate_pass')} for r in results]))
