...
def run(proposals, output_path):
    ...
    write_new(output_path,out);print(json.dumps([{k:r[k] for k in ('proposal_id','both_sides_same_bottle_piece_contact_reachable','sampled_forbidden_geometry_clear','CPU_necessary_gate_pass')} for r in results]))
