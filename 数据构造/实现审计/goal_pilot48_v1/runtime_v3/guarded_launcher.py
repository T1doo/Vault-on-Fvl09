...
from goal_pilot48_v1.runtime_v3.manifest_contract import (  # noqa: E402
    GUARD_ENTRY,
    POST_CHILD,
    canonical_hash,
    file_sha,
...
def main(argv=None) -> int:
    ...
    from goal_pilot48_v1.runtime_v3.manifest_contract import load_manifest
    if args.preflight_only:
        from goal_pilot48_v1.runtime_v3.job_runner import main as runner_main
