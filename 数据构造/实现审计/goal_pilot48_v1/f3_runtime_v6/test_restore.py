...
class Tests(unittest.TestCase):
    def case(self,primary=False,restore_error=False,full_valid=True,restore_keys=None):
        ...
        with tempfile.TemporaryDirectory(dir='/nfs_share/lijunhui/Robotwin2/tmp') as d,patch.object(micro,'_execute_inner',side_effect=inner),patch('goal_pilot48_v1.f3_one_sided_escape_v2.live.restore',side_effect=restore):
