...
def build_support_aware_motiongen(robot_config,world_export,witness,*,tensor_args,lease,batch=False):
    ...
    return mg,{'source_status':'ONE_SIDED_CERTIFICATE_V2_REQUIRES_REAL_GPU_CONFORMANCE','cache_audit':caches,'callback_audit':callback_audit,'attached_sphere_count':names.count('attached_bottle'),
