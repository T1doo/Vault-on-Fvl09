...
def attach_closed_bottle_model(scene,out):
    from goal_pilot48_v1.f3_tangent_escape_v1.live import prepare
...
def native_plan_gate(scene,controls,out):
    from goal_pilot48_v1.f3_tangent_escape_v1.live import native_gate
    return native_gate(scene,controls,out,_old_native_plan_gate)

def execute(scene,proposal,out):
    from goal_pilot48_v1.f3_tangent_escape_v1.live import restore
...
def _execute_inner(scene,proposal,out):
    ...
    def plan_and_execute(stage,actual):
        ...
        if stage=='lift25':
            from goal_pilot48_v1.f3_tangent_escape_v1.live import begin_plan
