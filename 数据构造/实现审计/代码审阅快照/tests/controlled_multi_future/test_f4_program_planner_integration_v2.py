...
class F4ProgramPlannerIntegrationV2Tests(unittest.TestCase):
    ...
    def test_planner_collision_scope_is_explicit_and_missing_scope_fails(self):
        ...
        self.assertFalse(terminal["dynamic_scene_object_collision_proven"])
        self.assertFalse(terminal["attached_carried_object_collision_proven"])
        self.assertFalse(terminal["physical_noninterference_proven"])
