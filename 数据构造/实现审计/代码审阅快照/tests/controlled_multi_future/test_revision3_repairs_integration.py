...
class Revision3RepairsIntegrationTest(unittest.TestCase):
    def test_f2_uses_drop_route_and_single_historical_safe_beside(self):
        ...
        self.assertIn("inside_gravity_drop_10cm_xy_comp_v8", source)
    ...
    def test_f4_uniform_seven_segment_route_is_used_for_staged_and_full(self):
        ...
        self.assertIn("_top_down_full_targets_v8", suffix)
        self.assertIn("_top_down_full_targets_v8", diagnostic)
    ...
    def test_revision3_budget_parent_and_source_bindings_are_closed(self):
        ...
        self.assertEqual(budget["maximum_new_implementation_revisions_per_family"], 9)
        ...
        self.assertEqual(parent["maximum_new_implementation_revisions_per_family"], 9)
