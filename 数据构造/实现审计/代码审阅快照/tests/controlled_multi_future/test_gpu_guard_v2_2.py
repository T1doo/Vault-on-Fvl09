...
from controlled_multi_future.probes.gpu_guard_v2_2 import (
...
def consumption():
    value = {
        "schema_version": "cmf_runtime_v3_1_authorization_consumption_v1_2",
        "authorization_id": "auth",
    ...
    from controlled_multi_future.probes.runtime_v3_1_authorization_v1_2 import canonical_sha256
...
class GpuGuardV2_2Test(unittest.TestCase):
    def setUp(self):
