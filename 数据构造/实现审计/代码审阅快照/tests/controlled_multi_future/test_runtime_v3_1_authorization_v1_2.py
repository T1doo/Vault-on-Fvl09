...
from controlled_multi_future.pre_stage0_authorization_v1 import (
    PARENT_SCHEMA_VERSION,
    build_scope_request,
    issue_authorization_from_scope_request,
)
from controlled_multi_future.probes.runtime_v3_1_authorization_v1_2 import (
    ...
    current_source_bindings_v1_2,
    sha256_file,
    validate_authorization_v1_2,
)
...
class RuntimeAuthorizationV1_2Test(unittest.TestCase):
    def setUp(self):
        ...
        self.command = ["python", "-m", "controlled_multi_future.probes.a0_real_sapien_adapter_smoke", "--authorization-receipt", str(self.auth_path)]
        ...
        self.source_lock = {
            ...
            "snapshot": {
                "family": "F1",
                "implementation_source_sha256": current_source_bindings_v1_2()["implementation_source_sha256"],
            },
        }

    def authorization(self):
        with mock.patch(
            "controlled_multi_future.pre_stage0_authorization_v1.validate_runtime_source_lock",
            ...
            return issue_authorization_from_scope_request(
                ...
                authorization_id="a0-auth-v5-1",
                authorized_run_id="a0-run-v5-1",
    ...
    def validate(self, value):
        with mock.patch(
            "controlled_multi_future.probes.runtime_v3_1_authorization_v1_2.load_runtime_source_lock",
            return_value=self.source_lock,
        ):
            return validate_authorization_v1_2(
                value,
