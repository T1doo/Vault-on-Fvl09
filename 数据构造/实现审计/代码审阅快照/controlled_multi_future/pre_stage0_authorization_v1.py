...
from .probes.runtime_v3_1_authorization_v1_2 import (
    ALLOWED_UUID_POLICY,
...
from .runtime_v3_1_budget_v1_2 import authorization_common_limits, scope_budget


PARENT_SCHEMA_VERSION = "cmf_pre_stage0_user_authorization_v1"
SCOPE_REQUEST_SCHEMA_VERSION = "cmf_pre_stage0_gpu_scope_request_v1"
...
def build_scope_request(
    *,
    ...
    request = {
        ...
        "source_bindings": current_source_bindings_v1_2(),
...
def validate_scope_request(value: Mapping[str, Any], parent: Mapping[str, Any]) -> dict:
    ...
    if value.get("source_bindings") != current_source_bindings_v1_2():
