...
def build_scope_bundle(
    *,
    ...
    if scope in ROOT_SCOPES and revision_index not in (1, 2, 3):
        raise ValueError("root scope bundle requires revision_index 1, 2, or 3")
    ...
    group = "runtime_v3_3_v1_2_gpu0_7"
