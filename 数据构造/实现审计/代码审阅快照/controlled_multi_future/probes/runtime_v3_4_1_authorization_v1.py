"""Request/source/budget-bound one-shot authorization for runtime-v3_4_1."""
...
AUTHORIZATION_SCHEMA_VERSION = "cmf_runtime_v3_4_1_gpu_authorization_v1"
CONSUMPTION_SCHEMA_VERSION = "cmf_runtime_v3_4_1_authorization_consumption_v1"
...
def implementation_source_sha256_v3_4_1() -> str:
...
def current_source_bindings_v3_4_1() -> dict[str, str]:
    root = Path(__file__).resolve().parents[1]
    paths = {
        "real_adapter_sha256": root / "real_sapien_adapter_v1_5.py",
        ...
        "f4_exact_selection_sha256": root
        / "f4_exact_corridor_selection_gate_v11.py",
        "f4_exact_A_gate_sha256": root
        / "f4_exact_corridor_a_gate_v11.py",
        "joint_limit_audit_sha256": root / "joint_limit_audit_v3_4_1.py",
        "single_program_gate_sha256": root
        / "single_program_strict_prefix_gate_v1_1.py",
        "budget_sha256": root / "runtime_v3_4_1_budget_v1.py",
        "scope_specs_sha256": root / "runtime_v3_4_1_scope_specs_v1.py",
        "scope_bundle_builder_sha256": root / "runtime_v3_4_1_scope_bundle_v1.py",
        "scheduler_sha256": root / "runtime_v3_4_multi_gpu_scheduler_v1.py",
        "scope_runner_sha256": root / "probes/runtime_v3_4_1_scope_runner.py",
        ...
        / "probes/runtime_v3_4_1_authorization_v1.py",
    }
    result = {name: sha256_file(path) for name, path in paths.items()}
    result["implementation_source_sha256"] = implementation_source_sha256_v3_4_1()
...
def validate_authorization_v3_4_1(
    ...
    *,
    ...
    if requested_scope not in SUPPORTED_SCOPES:
        raise AuthorizationScopeError("unsupported runtime-v3_4_1 scope")
    ...
    if receipt.get("allowed_physical_gpu_indices") != [0]:
        raise AuthorizationBindingError("runtime-v3_4_1 is restricted to physical GPU0")
...
def load_authorization_v3_4_1(
    ...
    return validate_authorization_v3_4_1(
...
__all__ = [
    ...
    "implementation_source_sha256_v3_4_1",
    "load_authorization_v3_4_1",
    "load_consumption_receipt",
    "validate_authorization_v3_4_1",
