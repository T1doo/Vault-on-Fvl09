"""Source-lock/request-bound atomic GPU guard for runtime-v3_2."""
...
GUARD_SCHEMA_VERSION = "cmf_gpu_guard_v2_3"
...
def require_atomic_gpu_guard_v2_3(
    authorization: Mapping[str, Any],
    consumption: Mapping[str, Any],
    *,
    expected_uuid: str,
    ...
    if not guard_path or not auth_path or not consumption_path or index_value != str(physical_index):
        raise GuardAuthorizationMismatch("child was not launched by bound GPU guard v2_3")
    try:
