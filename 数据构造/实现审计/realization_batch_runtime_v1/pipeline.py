...
def collect_cell(cell,output,*,shared_current_dir):
    ...
    try:
        ...
        with context as handle:
            ...
            try:
                current=adapter.capture_current(scene);require_same_current(reference,current)
                ...
                result['provenance'].update(trace_source_sha256=sha(trace),trace_source_relative_path='../trace_source.npz',development_data=True,
                    implementation_version='cmf_development_realization_batch_v1',parent_root=str(parent),parent_source_branch_sha256=cell['source_branch_file_sha256'],
