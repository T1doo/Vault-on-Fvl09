#!/usr/bin/env python3
"""Guard wrapper for the fail-closed, still-unconsumed F3 V2.1 reissue."""
...
def load_base_guard():
    ...
    spec = importlib.util.spec_from_file_location(
        "cmf_f3_reissue_v2_1_base_guard", BASE_GUARD
    )
...
def main(argv=None):
    ...
    if args.physical_index is None or args.expected_uuid is None:
        raise ValueError("F3 V2.1 runtime Guard requires GPU index and UUID")
