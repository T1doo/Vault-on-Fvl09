#!/usr/bin/env python3
"""Guard wrapper for the single approved F2 top-contact root."""
...
def load_base_guard():
    ...
    spec = importlib.util.spec_from_file_location("cmf_f2_top_contact_base_guard", BASE_GUARD)
...
def main(argv=None):
    ...
    if args.physical_index is None or args.expected_uuid is None:
        raise ValueError("F2 runtime Guard requires GPU index and UUID")
