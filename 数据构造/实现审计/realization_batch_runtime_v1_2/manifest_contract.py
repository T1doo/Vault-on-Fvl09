...
def validate_terminal(t):
    if t['previous_consumed_scene_count']!=1 or t['cumulative_scene_attempts']!=1+t['fresh_scene_attempts'] or t['cumulative_scene_cap']!=10 or t['cumulative_scene_attempts']>10:raise ValueError('cumulative scene recovery budget')
