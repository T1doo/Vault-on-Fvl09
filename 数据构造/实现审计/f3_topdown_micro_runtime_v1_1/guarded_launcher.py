...
def main(argv=None) -> int:
    ...
    try:
        ...
        start_receipt = {
            "schema_version": "cmf_f3_model_conformance_v1_guard_start_v1",
    ...
    terminal = {
        "schema_version": "cmf_f3_model_conformance_v1_guard_terminal_v1",
        "run_id": manifest["run_id"],
        "job_id": args.job_id,
        "family": job["family"],
        "manifest_sha256": manifest["manifest_sha256"],
    ...
    post_receipt = {
        "schema_version": "cmf_f3_model_conformance_v1_post_child_validation_v1",
        "manifest_sha256": manifest["manifest_sha256"],
        "job_id": args.job_id,
