...
class Tests(unittest.TestCase):
    def test_null_extra_links(self):
        import yaml
        from ik_config import P
        cfg=yaml.safe_load((P/'assets/embodiments/aloha-agilex/curobo_left.yml').read_text(encoding='utf-8'))['robot_cfg']['kinematics']
        self.assertIsNone(cfg['extra_links']);cfg['extra_links']=dict(cfg.get('extra_links') or {});cfg['extra_links']['test']={}
        self.assertEqual(cfg['extra_links'],{'test':{}})
