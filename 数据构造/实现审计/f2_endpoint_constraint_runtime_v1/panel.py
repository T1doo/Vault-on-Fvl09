...
def configure_solvers(scene,export,can):
    ...
    kin.setdefault('extra_links',{})['attached_can']={'parent_link_name':'fl_link6','link_name':'attached_can','fixed_transform':[0,0,0,1,0,0,0],'joint_type':'FIXED','joint_name':'attached_can_fixed'}
