...
class RedesignF2Scene(DenseTraceMixin, AuditScene):
    ...
    def load_actors(self):
        ...
        self.scale = create_box(self, sapien.Pose([0.08, -0.18, 0.755]), (0.06, 0.06, 0.005), color=(0.20, 0.20, 0.20), is_static=True, name="f2_redesign_scale")
        self.stand = create_box(self, sapien.Pose([0.23, -0.18, 0.79]), (0.05, 0.05, 0.035), color=(0.20, 0.20, 0.30), is_static=True, name="f2_redesign_stand")
