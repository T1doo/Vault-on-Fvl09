...
def dispatch(*, vault_execution_dir: str | Path, output_root: str | Path, root_id: str = "F3-A", timeout_seconds: int = 1800, existing_root: str | Path | None = None, programs: list[str] | tuple[str, ...] | None = None, qualification: bool = False, build_prefix: bool = False, single_cell: tuple[str, str] | None = None) -> dict[str, Any]:
...
def main():
    ...
    result = dispatch(vault_execution_dir=args.vault_execution_dir, output_root=args.output_root, root_id=args.root_id, timeout_seconds=args.timeout_seconds, existing_root=args.existing_root, programs=programs, qualification=args.qualification, build_prefix=args.build_prefix, single_cell=single_cell)
