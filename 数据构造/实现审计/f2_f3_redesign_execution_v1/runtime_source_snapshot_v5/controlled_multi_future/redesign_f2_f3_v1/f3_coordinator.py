...
def dispatch(*, vault_execution_dir: str | Path, output_root: str | Path, timeout_seconds: int = 300) -> dict[str, Any]:
    ...
    ledger = BudgetLedger(vault / "budget_ledger.jsonl", contract_sha256=contract_sha, parent_contract_sha256=contract.get("parent_contract_sha256"), task_id=contract["task_id"])
