...
def run_native_cohort(*, spec, realization, output, source_sha,source_compatibility=None,recovery_context=None):
    ...
    max_attempts = (
        8 if isinstance(recovery_context, dict) and recovery_context.get('mode') == 'motion_only' and recovery_context.get('allow_cohort_attempt8') is True
        else 7 if isinstance(recovery_context, dict) and recovery_context.get('mode') == 'motion_only' and recovery_context.get('allow_cohort_attempt7') is True
