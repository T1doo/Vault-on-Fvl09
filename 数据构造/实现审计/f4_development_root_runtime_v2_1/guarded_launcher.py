#!/usr/bin/env python3
"""Independent GPU Guard for a future externally-approved F4 V2.1 root."""
...
def _load_base_guard_primitives():
    ...
    spec = importlib.util.spec_from_file_location(
        "cmf_f4_v2_1_base_guard_primitives", BASE_GUARD
    )
...
def main(argv=None) -> int:
    ...
    try:
        ...
        if cache_job.exists():
            raise FileExistsError("F4 V2.1 cache job must be new")
    ...
    post_receipt = {
        "schema_version": "cmf_f4_development_root_v2_1_post_child_validation_v1",
        "manifest_sha256": manifest["manifest_sha256"],
        "job_id": args.job_id,
