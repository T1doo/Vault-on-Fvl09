...
def validate_manifest_semantics(
    ...
    *,
    ...
    if _required(value, "root_status", "manifest") != "INFRASTRUCTURE_FINAL_HARDENING_REQUIRED":
...
def _validate_lineage(value: Mapping[str, Any], *, execution_authorized: bool, fixture: bool) -> dict[str, Any]:
    ...
    if execution_authorized and not fixture:
        ...
        if (
            ...
            or "APPROVE_ONE_F4_INFRASTRUCTURE_CORRECTED_ROOT_V2"
            not in approval_path.read_text(encoding="utf-8")
        ):
