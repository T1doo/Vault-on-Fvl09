...
def build_support_aware_motiongen(robot_config,world_export,witness,*,tensor_args,batch=False):
    ...
    return mg,{'source_status':'PROPOSAL_REQUIRES_REAL_KERNEL_CONFORMANCE','cache_audit':caches,'callback_audit':callback_audit,'attached_sphere_count':names.count('attached_bottle'),
