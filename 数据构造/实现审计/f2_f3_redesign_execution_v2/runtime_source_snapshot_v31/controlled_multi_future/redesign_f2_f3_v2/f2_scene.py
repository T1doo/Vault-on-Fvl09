...
class RedesignF2Scene(DenseTraceMixin, AuditScene):
    ...
    def load_actors(self):
        ...
        if self._cmf_f2_layout_id in {"v2", "v3", "v4_beside_y_workspace"}:
            ...
            self.box_center[0] = (-0.12 if self._cmf_f2_layout_id == "v2" else -0.18) + shift_x
        ...
        self.beside_target_xy = np.asarray([0.06, -0.04], dtype=np.float64)
