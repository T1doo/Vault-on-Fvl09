...
def scene_spec(root_id: str) -> dict[str, Any]:
    ...
    if family == "F2":
        ...
        f2["support_point_local_xyz"] = [0.0, 0.0, 0.0]
        f2["support_point_source"] = "native builder actor-origin base pose; validated against asset center/scaled extents AABB"
        ...
        f2["beside_target_xy"] = [float(f2["stand_center_xyz"][0] + 0.120), float(f2["stand_center_xyz"][1])]
