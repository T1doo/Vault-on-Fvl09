...
class NativeAssetHandle:
    ...
    def __init__(self, entity: Any, spec: ModelSpec):
        ...
        self.config = {
            ...
            "collision_bounds_local": [list(spec.collision_bounds_local[0]), list(spec.collision_bounds_local[1])],
            "collision_support_point_local": list(spec.collision_support_point_local),
...
class RedesignF3Scene(DenseTraceMixin, AuditScene):
    ...
    def load_actors(self):
        ...
        spec = load_model_spec(asset_root, "114_bottle", model_id=1, asset_id="f3_bottle_v2")
