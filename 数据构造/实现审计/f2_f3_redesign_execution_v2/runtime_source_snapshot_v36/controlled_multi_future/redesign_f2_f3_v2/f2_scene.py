...
class RedesignF2Scene(DenseTraceMixin, AuditScene):
    ...
    def load_actors(self):
        ...
        self._cmf_f2_box_contract = {
            ...
            "collision_bounds_local_xyz": [list(spec.collision_bounds_local[0]), list(spec.collision_bounds_local[1])],
            "support_point_local_xyz": list(spec.collision_support_point_local),
            "grasp_point_local_xyz": list(spec.semantic_points.get("contact_0", (0.0, 0.0, 0.0))),
        }
